...
<body>
  ...
  <div id="note">ماتریس بزرگ‌نمایی شده (128x64 پیکسل) | آپلود عکس، سیاه‌سفید و کوچک می‌شود</div>
  ...
  <script>
    ...
    // آپلود عکس و رسم آن روی canvas و ارسال به ESP32
